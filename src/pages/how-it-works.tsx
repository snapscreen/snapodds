        ...
        <article className="mx-auto prose prose-xl max-w-full space-y-32">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="lead">
                We have a SDK production ready for iPhone iOS and Anroid. The
                integration is done easily and is well documented.
              </p>
            </div>
          </div>
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2">
              ...
              <p className="lead">
                Our snap interface works also in webbrowsers. A standard
                webbanner works perfectly as trigger for action.
              </p>
            </div>
            <div className="w-full md:w-1/2">
              <StaticImage
