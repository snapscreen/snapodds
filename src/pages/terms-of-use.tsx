...
const TermsOfUse: React.FC<PageProps> = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <Hero
        title="Terms of Use"
        lead="These Terms of Service (“Terms”) govern your access to and use of our services, including our websites, APIs, email notifications and applications. Please read these Terms fully and carefully before using the Services."
      ></Hero>
      <Container>
        <article className="prose prose-lg mx-auto">
          <p>
            The website located at snapscreen.com (the “Site”) is a copyrighted
            work belonging to Snapscreen Inc (“Company”, “us”, “our”, and “we”).
          ...
          <p>
            ...
            or endorsed by Company. Because you alone are responsible for your
          ...
          <p>
            ...
            RELATING TO THIS AGREEMENT. SOME JURISDICTIONS DO NOT ALLOW THE
          ...
          <p>
            The designated Copyright Agent for Company is: Snapscreen Inc,
            Email:{" "}
            <a href="mailto:copyrightnotice@snapscreen.com">
              copyrightnotice@snapscreen.com
            </a>
          </p>
          <h2>10. General</h2>
          <h3>10.1 Changes</h3>
          ...
          <p>
            ...
            relief. A Notice to the Company should be sent to: 9 E. LOOCKERMAN
            STREET SUITE 311, DOVER, Delaware 19901. After the Notice is
          ...
          <p>
            ...
            and compliance therewith, shall be strictly confidential. The
            parties agree to maintain confidentiality unless otherwise required
            by law. This paragraph shall not prevent a party from submitting to
            a court of law any information necessary to enforce this Agreement,
          ...
          <p>
            <strong>(m) Small Claims Court.</strong> Notwithstanding the
            foregoing, either you or the Company may bring an individual action
            in small claims court.
          </p>
          <p>
            <strong>(n) Emergency Equitable Relief.</strong> Notwithstanding the
          ...
          <p>
            <strong>(o) Claims Not Subject to Arbitration.</strong>{" "}
          ...
          <p>
            <strong>(p) Courts.</strong> In any circumstances where the
            ...
            jurisdiction of the courts located within Kent County, Delaware, for
            such purpose.
          </p>
          <h3>10.3 Export</h3>
          <p>
          ...
          <p>
            Copyright © 2020 Snapscreen Inc. All rights reserved. All
          ...
          <p>
            Email:{" "}
            <a href="mailto:hello@snapodds.tv">hello@snapscreen.com</a>
          </p>
        </article>
      </Container>
    </Layout>
